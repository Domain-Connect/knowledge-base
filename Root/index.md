...
**Domain Connect** is an open-standard protocol that automates DNS configuration when a user connects a domain to a third-party service — eliminating the manual DNS record entry that causes ~50% of users to give up.

Choose the edition that fits your role:
...
Covers the business case, key messages, soundbites, storytelling guides, and audience-specific narratives.
...
Covers the technical protocol, template structure, security model, step-by-step implementation guides, and IETF participation.
